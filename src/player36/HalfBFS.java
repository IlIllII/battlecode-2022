...
public class HalfBFS {
    ...
    /**
     * Performs bread first search only on tiles that are equidistant or closer
     * to the target location. This results in less than half the cost of full BFS.
     * 
     * @param rc
     * @param target
     * @return direction to move.
     */
    public static Direction getBestDir(RobotController rc, MapLocation target) {
        ...
        /*
         * Like ThreeQuarterBFS, we only check a subset of tiles in vision radius.
         */
        try {
