...
public class ThreeQuarterBFS {
    // See FullBFS for more details.
    ...
    /**
     * Performs breadth first search on all tiles in vision range
     * with the exception of those in a wedge behind the unit,
     * resulting in searching about 3/4 the amount of tiles as full BFS.
     * 
     * @param rc
     * @param target
    ...
    static Direction getBestDir(RobotController rc, MapLocation target) {
        ...
        /*
         * Since we aren't searching all tiles and instead are searching
         * directionally, we assign tiles relative to a "north" direction that
         * is passed in.
         */
        ...
        /*
         * We check tiles similar to full BFS, but only the subset of tiles
         * we have selected.
         */
        try {
            ...
            /*
             * Can we switch on a tile? That could make this faster. We need to use tiles
             * rather than integers because we are specifying them relative to a direction.
             */
            ...
            /*
             * Since tiles are relative to a direction, we can get away with only computing
             * tile
             * distances for the subset of frontier tiles that are closer to the target than
